...
class ScreenMetalView: MTKView {
    ...
    // MARK: - Internal bounds
    private var internalBounds: CGRect!
    
    // MARK: - Texture transform
...
extension ScreenMetalView {
    ...
    func viewPointForTexture(point: CGPoint) -> CGPoint? {
        ...
        guard let transform = textureTransform?.inverted() else {
            return result
        }
...
extension ScreenMetalView.Rotation {
